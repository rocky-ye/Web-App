...
### A full stack web development project utilizing AWS S3 & RDS for cloud backend storage, a python machine learning pipeline for modeling, Flask and CSS for the front end web page, Docker for deployment.
